...
const Navbar = () => {
  return (
    <div className="fixed z-40 mt-0 flex w-full justify-between bg-black px-10 py-6 max-md:px-5">
      <h1 className="ml-10 text-2xl font-bold text-white">WebTech</h1>
      <ul className="justify-center gap-x-10 text-white max-md:hidden lg:flex">
